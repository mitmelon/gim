...
class UTF8
{
    ...
    */
    public function utf8_url_slug($str = '', $maxl = -1, $trns = false)
    {
    ...
    */
    ...
    public function utf8_chr($code_point)
    {
    ...
    */
    ...
    public function utf8_clean($str, $remove_bom = false)
    {
    ...
    */
    ...
    public function utf8_split($str, $split_length = 1)
    {
        $str	= ( string ) $str;
    ...
    */
    ...
    public function utf8_chunk_split($body, $chunklen = 76, $end = "\r\n")
    {
    ...
    */
    ...
    public function utf8_fits_inside($str, $box_size)
    {
    ...
    */
    ...
    public function utf8_chr_size_list($str)
    {
    ...
    */
    ...
    public function utf8_max_chr_width($string)
    {
        return max($this->$this->utf8_chr_size_list($string));
    }
    ...
    */
    ...
    public function utf8_single_chr_html_encode($chr)
    {
    ...
    */
    ...
    public function utf8_html_encode($str)
    {
     ...
     *
     * substr works with bytes, while $this->utf8_substr works with characters
     * and are identical in all other aspects.
    */
    
    public function utf8_substr($str, $start = 0, $length = null)
    {
    ...
    */
     ...
     * @since 1.0
     *
     * @param    string $$this->utf8_chr The input string
     * @return   bool True if the $$this->utf8_chr is Byte Order Mark, False otherwise
    */
    
    public function is_bom($utf8_chr)
    {
    ...
    */
    ...
    public function utf8_file_has_bom($file_path)
    {
    ...
    */
    ...
    public function utf8_string_has_bom($str)
    {
    ...
    */
    ...
    public function utf8_add_bom_to_string($str)
    {
    ...
    */
    ...
    public function utf8_str_shuffle($str)
    {
        $array    = $this->utf8_split($str);
    ...
    */
    ...
    public function utf8_count_chars($str)    //there is no $mode parameters
    {
    ...
    */
     ...
     *
     * strpos works with bytes, while $this->utf8_strpos works with characters
     * and are identical in all other aspects.
    */
    ...
    */
    ...
    public function utf8_codepoints($arg, $u_style = false)
    {
        if (is_string($arg)) {
            $arg    = $this->utf8_split($arg);
        }
        
        $arg    = array_map('$this->utf8_ord', $arg);
        
        if ($u_style) {
            $arg    = array_map('$this->utf8_int_to_hex', $arg);
        }
    ...
    */
    ...
    public function utf8_int_to_hex($int, $pfix = 'U+')
    {
    ...
    /**
     * $this->utf8_hex_to_int( )
     *
     * Opposite to $this->utf8_int_to_hex( )
    ...
    */
    ...
    public function utf8_hex_to_int($str)
    {
    ...
    */
    ...
    public function utf8_chr_to_hex($chr, $pfix = 'U+')
    {
    ...
    */
    ...
    public function utf8_word_count($str)
    {
    ...
    */
    ...
    public function utf8_string($array)
    {
        return implode(array_map('$this->utf8_chr', $array));
    }
    
    
    /**
     * $this->utf8_substr_count( )
     *
    ...
    */
    ...
    public function utf8_substr_count($haystack, $needle, $offset = 0, $length = null)
    {
        if ($offset || $length) {
    ...
    */
    ...
    public function utf8_range($var1, $var2)
    {
        if (ctype_digit(( string ) $var1)) {
            $start    = ( int ) $var1;
        } elseif (!($start = ( int ) $this->utf8_hex_to_int($var1))) {
        ...
        if (ctype_digit(( string ) $var2)) {
            $end    = ( int ) $var2;
        } elseif (!($end = ( int ) $this->utf8_hex_to_int($var2))) {
            //if not u+0000 style codepoint
        ...
        return array_map('$this->utf8_chr', range($start, $end));
    }
    ...
    */
    ...
    public function utf8_hash($len = 8)
    {
        static $chrs        = array( );
        ...
        if (!$chrs) {
            if ($this->pcre_utf8_support()) {
                $chrs    = array_map('$this->utf8_chr', range(48, 0xffff));
     ...
     * @since 1.2
     *
     * @param    string $callback The callback public function
     * @param    string $str UTF-8 string to run callback on
     * @return   array The outcome of callback
    */
    
    public function utf8_chr_map($callback, $str)
    {
     ...
     * utf8_callback( )
     *
     * @Alias of $this->utf8_chr_map( )
     * @since 1.2
    */
    
    public function utf8_callback($callback, $str)
    {
    ...
    */
    ...
    public function utf8_access($string, $pos)
    {
        //return the character at the specified position: $str[1] like public functionality
    ...
    */
    ...
    public function utf8_str_sort($str, $unique = false, $desc = false)
    {
    ...
    */
    ...
    public function utf8_strip_tags($string, $allowable_tags = '')
    {
        //clean broken utf8
    ...
    */
    ...
    public function utf8_str_replace($search, $replace, $subject, &$count = 0)
    {
    ...
    */
    ...
    public function utf8_str_repeat($string, $multiplier)
    {
    ...
    */
    ...
    public function utf8_str_pad($input, $pad_length, $pad_string = ' ', $pad_type = STR_PAD_RIGHT)
    {
        ...
        if (is_int($pad_length) && ($pad_length > 0) && ($pad_length >= $input_length)) {
            ...
            switch ($pad_type) {
                case STR_PAD_LEFT:
                        $pre    = $this->utf8_str_repeat($pad_string, ( int ) ceil($diff / $ps_length));
                        $pre    = $this->utf8_substr($pre, 0, $diff);
                        $post    = '';
    ...
    */
    ...
    public function utf8_strrpos($haystack, $needle, $offset = 0)
    {
        if ((( int ) $needle) === $needle && ($needle >= 0)) {
            $needle    = $this->utf8_chr($needle);
        }
    ...
    */
    ...
    public function utf8_remove_duplicates($str, $what = ' ')
    {
        if (is_string($what)) {
            $what    = array( $what );
        }
    ...
    */
    ...
    public function utf8_trim_util(&$string, &$chrs)
    {
        if (empty($chrs)) {
            $chrs    = $this->utf8_ws();
        } elseif (is_string($chrs)) {
            $chrs   = $this->utf8_split($chrs);
        }
        
        $chrs   = array_flip($chrs);
        
        $string    = $this->utf8_clean($string);    //Cleanup is necessary here, or trim public functions may break
    }
    ...
    */
    ...
    public function utf8_trim($string = '', $chrs = '')
    {
    ...
    */
    ...
    public function utf8_ltrim($string = '', $chrs = '')
    {
    ...
    */
    ...
    public function utf8_rtrim($string = '', $chrs = '')
    {
        $this->utf8_trim_util($string, $chrs);
    ...
    */
    ...
    public function utf8_strtolower($str)
    {
        static $table = null;
    ...
    */
    ...
    public function utf8_strtoupper($str)
    {
        static $table = null;
    ...
    */
    ...
    public function utf8_case_table()
    {
        static $case = array(
    ...
    */
    ...
    public function utf8_lcfirst($str)
    {
    ...
    public function utf8_ucwords($str)
    {
        foreach ($this->utf8_ws() as $ws) {
            ...
            while (true) {
                ...
                $str    = $this->utf8_substr($str, 0, $pos + 1) . $this->utf8_strtoupper($this->utf8_substr($str, $pos + 1, 1)) . $this->utf8_substr($str, $pos + 2);
            }
        }
    ...
    */
    ...
    public function utf8_stripos($haystack, $needle, $offset = 0)
    {
    ...
    */
    ...
    public function utf8_strripos($haystack, $needle, $offset = 0)
    {
